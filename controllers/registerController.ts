...
export const creteStudentRegister = async (req: Request, res: Response) => {
    try {
...
export const updateRegister = async (req: Request, res: Response) => {
    try {
        const id = req.query.student_id as string;
...
export const registerClassByFindClassId = async (req: Request, res: Response) => {
    try {
...
export const registerClassByFindStudentId = async (req: Request, res: Response) => {
    try {
        const id = req.query.student_id as string;
...
export const getAllRegisters = async (_req: Request, res: Response) => {
    try {
...
export const deleteRegisterClassByRegisterId = async (req: Request, res: Response) => {
    try {
